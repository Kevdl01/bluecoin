...
for Ubuntu Xenial does not produce working executables for some of the Bluecoin Core applications.
...
The next three steps are an example of how to acquire the source in an appropriate way.
    ...
    cd /usr/src
    sudo git clone https://github.com/bluecoin-project/bluecoin.git
    sudo chmod -R a+rw bluecoin
...
causes two of the bluecoin executables to crash shortly after start up. The bug is related to the
...
It's not possible to build the bluecoin code using the win32 version of the Mingw-w64 cross compilers (at least not without
modifying headers in the bluecoin source code).
